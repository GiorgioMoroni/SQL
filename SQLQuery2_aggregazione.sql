...
--CONTA TUTTI I DIPENDENTI RAGGRUPPATI IN UN DIPARTIMENTO
...
--MEDIA SALARIO PER DIPARTIMENTO
SELECT Department, AVG(Salary)
	FROM Employees
	GROUP BY Department;

--SOMMA SALARI PER DIPARTIMENTO
...
--MASSIMO SALARIO PER DIPARTIMENTO
SELECT Department, MAX(Salary)
	FROM Employees
	GROUP BY Department;
	 
--MINIMO SALARIO PER DIPARTIMENTO
